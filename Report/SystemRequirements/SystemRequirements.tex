...
In this chapter we will present the system requirements, discovered both through conversation with the customer about their vision and through brainstorming sessions within the group. Since we were only given a brief vision of what the customer wanted, most requirements comes from the brainstorming sessions. The system requirements are divided into functional and nonfunctional requirements and will be described in more detail through a series of use-cases at the end of this section.

\subsection{Definitions, acronyms and abbreviations}
\label{subsec:SysIntroReqDefs}

\subsubsection*{User}
A user is in this case the end-user of the web page. Since the web page are directed towards youth the typical end-user will be a teenager. 
...
An administrator is a person that can control and configure a part of a system or the entirety  of a system. In this system there are two types of administrators,  group administrators and system administrators. A group administrator is typically an end-user controlling a group page. A system administrator can control and make changes to the entire system.

\paragraph{Overview:}
The system is a social platform for urban youth to express themselves. The users of the system will have the ability to upload pictures and videos to specific locations, host events and post comments. The system will be realized as a web page.

\subsection{Overall description}
\label{subsec:SysReqIntroDescr}

\paragraph{Product Perspective:} At T\o yen in Oslo, a number of new outdoor places for the youth are in the process of being built. As a part of that process, the researchers at AFI and the local politicians in the area wants input from the youth themselves. They want to see how the youth in the area express themselves both through picture and video uploads and through written comments. With this information they hope to get a better understanding of what can be done in order to improve the everyday life of the youth in the area. As well as being a source of information, the media uploads and comments will also create a social platform on its own where the youth can connect.
...
\subsubsection*{Youth:}
As this system are aimed towards the youth, most of the users will be in the age of 12 to 20 years old. This is mostly users with prior experience of media sharing web pages and a user group that expects a certain level of intuitive design and functionality.
...
\section{Nonfunctional and functional requirements}
...
The web page will be compatible with all modern web browsers. These include Google Chrome, Firefox, Safari and Opera. For the front end of the page we use HTML version 5 and CSS version 3.
...
\begin{tabular}{|l|p{7cm}|}
  ...
  \hline
\end{tabular}
\captionof{table}{Use case for login. \label{tab:SysReqUseCasesLogin}}
\end{minipage}
...
\clearpage
    \centering
    \begin{figure}
        \includegraphics[width=105mm]{./SystemRequirements/img/uploadUC.png}
