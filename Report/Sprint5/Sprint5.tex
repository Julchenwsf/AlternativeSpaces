...
\begin{itemize}
  ...
  \item The report work should be uploaded in Google Docs immediately after completion so they can be proofread by other group members.
