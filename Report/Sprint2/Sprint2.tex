...
\section{Sprint Plan}
\label{sec:S2Plan}
As the first draft of a product backlog had now been created, the group was able to pull a number of items off the product backlog and into the sprint backlog, as shown in table \ref{tab:S2Backlog}. As most members were inexperienced in the field of web application development, and had used the previous sprint getting to know the technology better, this was the first Sprint where inexperienced started contributing to the implementation.
...
Table \ref{tab:S2Backlog} show the backlog for the second sprint. \\ D: Design, F:Feature, TA: Task, TE: Test, 
...
\hline
TA2.1 & Structurize Google Drive folders, and use the same language in all documents. & 1 week & 21h \\
TA2.2 & Set up NTNU home area for running and testing code. & 2h & 2h \\
TE2.3 & Use NTNU's MySQL server over SSH for testing database of user sign up, user creation, validation etc. & 4h & 4h \\
D2.4.1 & Find and apply a theme color for the web page. & 3h & 4h \\
D2.4.2 & Find and apply a background color for the web page. & 3h & 4h \\
D2.5.1 & Registration form: Layout. & 1h & 3h \\
F2.5.1 & Registration form: Sign up back end. & 1w & 20h \\
D2.6.1 & Sign in form: Layout. & 1h & 1h \\
F2.6.1 & Create the sign in form. & 2h & 2h \\
F2.6.2 & Validation used to make sure that all input fields are valid before saving to the database. & 2h & 2h\\
D2.7.1 & Logo icon and logo text. & 1h & 1h \\
D2.7.2 & Sign in button and Sign out button. & 1h & 1h \\
D2.7.3 & Sign up button. & 1h & 1h \\
D2.7.4 & Validation of forms: Error message with styles when invalid information is input. & 1h & 1h \\
F2.7.1 & Back-end functionality of sign in and sign out. & 2h & 3h \\
F2.7.2 & Back-end functionality for sign up and user creation. & 2h & 3h \\
F2.7.3 & Back-end functionality for validation check of forms. & 2h & 3h \\
D2.8.1 & Center photo posts, taking the map-sidebar-search into account. & 1h & 1h \\
F2.8.3 & Commenting on photos & 6h & 7h \\
F2.8.2 & Mouse-hover on photos enlarge. & 1h & 2h \\
R2.9.1 & Update and finish the Requirements Specification Document. & 4h & 5h \\
\hline
\end{tabular}
