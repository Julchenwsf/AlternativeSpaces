...
\begin{tabular}{ |l|p{70mm}| }
	...
	\it{\cellcolor{gray!25}Expected results} & Overlay window with sign in fields will pop up. An error message will be displayed if fields are incorrect or invalid. If all information input is valid, the user will be signed in.  \\
	\hline
\end{tabular}
...
\begin{tabular}{ |l|p{70mm}| }
	...
	\it{\cellcolor{gray!25}Feature to be tested} & User signing out after signing in \\ \hline
	\it{\cellcolor{gray!25}Requirements} & F1, F2   \\ \hline
...
\begin{tabular}{ |l|p{70mm}| }
	...
	\it{\cellcolor{gray!25}Item} & {\cellcolor{gray!25} Description } \\
	\hline
	\it{\cellcolor{gray!25}Test Name } & Sign Out: app \\ \hline
...
\begin{tabular}{ |l|p{70mm}| }
	...
	\it{\cellcolor{gray!25}Item} & {\cellcolor{gray!25} Description } \\
	\hline
	\it{\cellcolor{gray!25}Test Name } & Search Address \\ \hline
...
\begin{tabular}{ |l|p{70mm}| }
	...
	\it{\cellcolor{gray!25}Expected results} & Replies are displayed within existing threads and new comments start new threads, with the text the user entered as input. Comments are saved in database and displayed on webpage. \\
	\hline
\end{tabular}
...
\begin{tabular}{ |l|p{70mm}| }
	...
	\it{\cellcolor{gray!25}Feature to be tested} & Commenting on photo page \\ \hline
	\it{\cellcolor{gray!25}Requirements} & F17 \\ \hline
...
Error message is displayed when username taken or password is blank.; Also avoid special characters like “\_ ” in username \\ \hline
	...
	\it{\cellcolor{gray!25}TC7} & Success, no events in the past creatable, number of envited people can not be empty or letters, shows error message \\ \hline
