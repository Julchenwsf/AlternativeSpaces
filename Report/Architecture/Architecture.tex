...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{img/LogicView.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{img/PhysicalView.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{img/DevelopmentView.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{img/ProcessView.png}
...
\begin{figure}
\centering
\includegraphics[width=90mm]{img/clientserver2.png}
...
\begin{figure}
\centering
\includegraphics[width=90mm]{img/threetier.jpg}
\caption{Visual example of the Client-Server Architecture. \label{overflow}}
\end{figure}
