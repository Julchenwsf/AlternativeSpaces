...
\begin{figure}[htbp]
\centering
\includegraphics[width=70mm]{./Architecture/img/threetier.jpg}
\caption{Visual example of the Client-Server Architecture. \label{overflow}}
\end{figure}
